...
function buildNodeConfig(globalConfig: AiConfig, node: CanvasNodeData, mode: CanvasNodeGenerationMode): AiConfig {
    ...
    return {
        ...
        imageResponseFormat: node.metadata?.imageResponseFormat || globalConfig.imageResponseFormat || defaultConfig.imageResponseFormat,
        ...
        videoInferenceSteps: node.metadata?.videoInferenceSteps || globalConfig.videoInferenceSteps || defaultConfig.videoInferenceSteps,
        ...
        agnesVideoMode: node.metadata?.agnesVideoMode || globalConfig.agnesVideoMode || defaultConfig.agnesVideoMode,
